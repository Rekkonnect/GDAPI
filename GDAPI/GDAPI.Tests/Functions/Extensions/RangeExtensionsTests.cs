...
namespace GDAPI.Tests.Functions.Extensions
{
    ...
    {
        private readonly List<Range> unsortedRanges = new() { 0..4, 7..12, 12..15, 1..3, 2..3, 0..1, 16..23, 17..18, 8..10 };
        private readonly List<int> sortedRangeStarts = new() { 0, 0, 1, 2, 7, 8, 12, 16, 17 };
        private readonly List<Range> mergedRanges = new() { 0..4, 7..15, 16..23 };
