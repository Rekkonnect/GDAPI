...
{
    /// <summary>Provides basic editor tools to edit a level, such as moving, rotating, selecting, deleting, etc.</summary>
    public class BasicEditor : BaseObjectSelectionPluggableEditor
    {
        ...
        #region Constructors
        /// <summary>Initializes a new instance of the <seealso cref="BasicEditor"/> class.</summary>
        ...
        public BasicEditor(Bindable<Editor> master)
            : base(master) { }
        #endregion
        ...
        {
            if (registerUndoable)
                RegisterEditorAction(new SwipeChanged(value, SetSwipe));
        ...
        {
            if (registerUndoable)
                RegisterEditorAction(new GridSnapChanged(value, SetGridSnap));
        ...
        {
            if (registerUndoable)
                RegisterEditorAction(new FreeMoveChanged(value, SetFreeMove));
        ...
        {
            if (registerUndoable)
                RegisterEditorAction(new ZoomChanged(newValue, oldValue, SetZoom));
        ...
        {
            if (registerUndoable)
                RegisterEditorAction(new GridSizeChanged(newValue, oldValue, SetGridSize));
        ...
        {
            if (registerUndoable)
                RegisterEditorAction(new DualLayerModeChanged(value, SetFreeMove));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new SelectedObjectsAdded(objects, SelectObjects, DeselectObjects));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new SelectedObjectsRemoved(objects, DeselectObjects, SelectObjects));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new AllObjectsDeselected(previousSelection, DeselectAll, SelectObjects));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsCreated(objects, AddObjects, RemoveObjects));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsDeleted(objects, RemoveObjects, AddObjects));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsMoved(objects, offset, Move));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsRotated(objects, offset, centralPoint, Rotate));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsRotated(objects, scaling, centralPoint, Scale));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsFlippedHorizontally(objects, centralPoint, FlipHorizontally));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsFlippedVertically(objects, centralPoint, FlipHorizontally));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsCopied(newObjects, oldObjects, Copy));
        ...
        public void OnObjectsPasted(LevelObjectCollection objects, Point centralPoint, bool registerUndoable = true)
        {
            ...
            if (registerUndoable)
                RegisterLevelAction(new ObjectsPasted(objects, centralPoint, Paste, RemoveObjects));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ObjectsCopyPasted(newObjects, oldObjects, CopyPaste, UndoCopyPaste));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new ColorChanged(colorID, newColor, oldColor, ChangeColorChannelColor));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new BlendingChanged(colorID, ChangeColorChannelBlending));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new GroupIDsAdded(objects, groupIDs, AddGroupIDs, RemoveGroupIDs));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new GroupIDsAdded(objects, groupIDs, RemoveGroupIDs, AddGroupIDs));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new MainColorIDsChanged(objects, colorIDDifference, colorChannel.ColorChannelID, ChangeMainColorID));
        ...
        {
            if (registerUndoable)
                RegisterLevelAction(new DetailColorIDsChanged(objects, colorIDDifference, colorChannel.ColorChannelID, ChangeMainColorID));
        ...
        public void Rotate(LevelObjectCollection objects, double rotation, bool individually, bool registerUndoable = true)
        {
            if (individually)
            {
                ...
                Rotate(objects, rotation, SelectedObjects.GetMedianPoint(), registerUndoable);
        }
        ...
        public void Scale(LevelObjectCollection objects, double scaling, bool individually, bool registerUndoable = true)
        {
            if (individually)
            {
                ...
                Scale(objects, scaling, SelectedObjects.GetMedianPoint(), registerUndoable);
        }
        ...
        public void FlipHorizontally(LevelObjectCollection objects, bool individually, bool registerUndoable = true)
        {
            if (individually)
            {
                ...
                FlipHorizontally(objects, SelectedObjects.GetMedianPoint(), registerUndoable);
        }
        ...
        public void FlipVertically(LevelObjectCollection objects, bool individually, bool registerUndoable = true)
        {
            if (individually)
            {
                ...
                FlipVertically(objects, SelectedObjects.GetMedianPoint(), registerUndoable);
        }
        ...
        public void Paste(LevelObjectCollection objects, Point center, bool registerUndoable = true)
        {
            if (objects.Count == 0)
                return;
            var offset = center - objects.GetMedianPoint();
            var newObjects = objects.Clone();
            newObjects.ApplyLocationOffset(offset);
        ...
        /// <param name="registerUndoable">Determines whether the events will be invoked. Defaults to <see langword="true"/> and must be set to <see langword="false"/> during undo/redo to avoid endless invocation.</param>
        public void SetSwipe(bool value, bool registerUndoable = true) => SetField(ref swipe, value, OnSwipeChanged, registerUndoable);
        ...
        /// <param name="registerUndoable">Determines whether the events will be invoked. Defaults to <see langword="true"/> and must be set to <see langword="false"/> during undo/redo to avoid endless invocation.</param>
        public void SetGridSnap(bool value, bool registerUndoable = true) => SetField(ref gridSnap, value, OnGridSnapChanged, registerUndoable);
        ...
        /// <param name="registerUndoable">Determines whether the events will be invoked. Defaults to <see langword="true"/> and must be set to <see langword="false"/> during undo/redo to avoid endless invocation.</param>
        public void SetFreeMove(bool value, bool registerUndoable = true) => SetField(ref freeMove, value, OnFreeMoveChanged, registerUndoable);
        ...
        /// <param name="registerUndoable">Determines whether the events will be invoked. Defaults to <see langword="true"/> and must be set to <see langword="false"/> during undo/redo to avoid endless invocation.</param>
        public void SetZoom(double value, bool registerUndoable = true) => SetField(ref zoom, value, OnZoomChanged, registerUndoable);
        ...
        /// <param name="registerUndoable">Determines whether the events will be invoked. Defaults to <see langword="true"/> and must be set to <see langword="false"/> during undo/redo to avoid endless invocation.</param>
        public void SetGridSize(double value, bool registerUndoable = true) => SetField(ref gridSize, value, OnGridSizeChanged, registerUndoable);
        ...
        /// <param name="registerUndoable">Determines whether the events will be invoked. Defaults to <see langword="true"/> and must be set to <see langword="false"/> during undo/redo to avoid endless invocation.</param>
        public void SetDualLayerMode(bool value, bool registerUndoable = true) => SetField(ref dualLayerMode, value, OnDualLayerModeChanged, registerUndoable);
        #endregion
        ...
        private void SetField(ref bool field, bool value, ValueChangedHandler<bool> handler, bool registerUndoable = true)
        {
            if (value == field)
                return;
            handler(field = value, registerUndoable);
        }
        private void SetField(ref double field, double value, OldNewValueChangedHandler<double> handler, bool registerUndoable = true)
        {
            if (value == field)
                return;
            double old = field;
