...
namespace GDAPI.Objects.GeometryDash.LevelObjects.Triggers
{
    ...
    public class MoveTrigger : Trigger, IHasDuration, IHasEasing, IHasTargetGroupID, IHasSecondaryGroupID
    {
        ...
        public override int ConstantObjectID => (int)TriggerType.Move;
        ...
        [ObjectStringMappable(ObjectProperty.LockToPlayerX, false)]
        ...
        [ObjectStringMappable(ObjectProperty.LockToPlayerY, false)]
        ...
        [ObjectStringMappable(ObjectProperty.EnableUseTarget, false)]
        ...
        [FutureProofing("2.2")]
        [ObjectStringMappable(ObjectProperty.LockToCameraX, false)]
        ...
        [FutureProofing("2.2")]
        [ObjectStringMappable(ObjectProperty.LockToCameraY, false)]
        ...
        [ObjectStringMappable(ObjectProperty.TargetPosGroupID, 0)]
