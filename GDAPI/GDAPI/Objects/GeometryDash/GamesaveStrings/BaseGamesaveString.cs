...
namespace GDAPI.Objects.GeometryDash.GamesaveStrings
{
    ...
    public abstract class BaseGamesaveString
    {
        ...
        public int Length => RawString?.Length ?? 0;
        ...
        /// <summary>Determines whether the string is empty or not. Prefer using this property over <seealso cref="RawString"/>, to avoid requiring a null check.</summary>
        ...
        /// <summary>Returns the decrypted version of the gamesave after checking whether the gamesave is encrypted or not asynchronously.</summary>
        /// <param name="overwriteLocalString">Determines whether to overwrite the locally stored raw string or not, replacing it with the decrypted version.</param>
        /// <returns>A <seealso cref="DecryptionResult"/> containing the result of the decryption operation.</returns>
        ...
        /// <summary>Returns the encrypted version of the gamesave after checking whether the gamesave is encrypted or not asynchronously.</summary>
        /// <param name="overwriteLocalString">Determines whether to overwrite the locally stored raw string or not, replacing it with the encrypted version.</param>
        /// <returns>An <seealso cref="EncryptionResult"/> containing the result of the encryption operation.</returns>
