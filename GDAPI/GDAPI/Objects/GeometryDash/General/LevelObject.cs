...
namespace GDAPI.Objects.GeometryDash.General
{
    public class LevelObject
    {
        ...
        public LevelObject() { this[ObjectProperty.ObjectID] = 1; }
        ...
        public LevelObject(int objID) { this[ObjectProperty.ObjectID] = objID; }
        ...
        {
            this[ObjectProperty.ObjectID] = objID;
            ...
            for (int i = 1; i < PropertyCount; i++)
                if (Parameters[i] != null)
                {
                    ...
                    if (i > 3)
                    {
                        ...
                        else if (i == (int)ObjectProperty.Color1HSV || i == (int)ObjectProperty.Color2HSV || i == (int)ObjectProperty.CopiedColorHSVValues)
                        {
                            parameter += i + ",";
